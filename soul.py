...
TOKEN = '7625547292:AAGij81Nmu-VQk2jxx9ereVXd2wS6ldTeyw'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1001512763847
CHANNEL_ID = -1001512763847
error_channel_id = -1001512763847
...
def approve_or_disapprove_user(message):
    ...
    if not is_admin:
        bot.send_message(chat_id, "*🚫 Access Denied!*\n"
                                   "*You don't have permission plz DM @GODNEXTYT .*", parse_mode='Markdown')
        return
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @GODNEXTYT*", parse_mode='Markdown')  # Contact owner message
            return
        ...
        bot.send_message(chat_id, "*💣 Ready to launch an attack?*\n"  # Ready to launch message
                                   ...
                                   "*https://t.me/+YrWcZVAVyYNmNTM1*", parse_mode='Markdown')  # Start chaos message
